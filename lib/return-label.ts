  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      const doc = new PDFDocument({
        ...
        font: fs.existsSync(fontPath) ? fontPath : undefined, // Use custom font as default to avoid Helvetica.afm error
      });
      ...
      // Register and use Roboto-Regular.ttf from the public directory for all PDF text
      if (fs.existsSync(fontPath)) {
        doc.registerFont("CustomSans", fontPath);
        doc.font("CustomSans");
      }
      ...
      doc.fontSize(14).font("CustomSans").text("Return Details");
      doc
        .fontSize(10)
        .font("CustomSans")
      ...
      doc.fontSize(14).font("CustomSans").text("Shipping Instructions");
      doc
        .fontSize(10)
        .font("CustomSans")
        .text(
      ...
      doc.fontSize(14).font("CustomSans").text("Return Address");
