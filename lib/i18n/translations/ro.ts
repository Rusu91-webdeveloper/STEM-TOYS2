...
export const ro = {
  ...
  continueToShipping: "Continuă la metoda de livrare",
  backToCart: "Înapoi la coș",
  backToShipping: "Înapoi la adresa de livrare",
  backToShippingMethod: "Înapoi la metoda de livrare",
  placeOrder: "Plasează comanda",
  orderSummary: "Rezumatul comenzii",
  shippingInfo: "Informații de livrare",
  deliveryEstimate: "Estimare livrare",
  billingAddress: "Adresa de facturare",
  sameAsShipping: "Aceeași ca adresa de livrare",
  selectAddress: "Selectează adresa",
