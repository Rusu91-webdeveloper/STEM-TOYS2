...
import { BookOpen, FileText, Users, Upload, Eye, Settings } from "lucide-react";
      ...
      <Card>
        <CardContent className="py-12">
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold mb-2">Nu există cărți</h3>
            <p className="text-muted-foreground mb-4">
              Nu ai încă nicio carte în sistem. Cărțile se creează automat când
              sistemul pornește.
            </p>
            <p className="text-sm text-muted-foreground">
              Dacă nu vezi cărțile, verifică că aplicația rulează corect și că
            ...
            <div className="space-y-3">
              ...
              <div className="bg-muted/50 rounded-lg p-3">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Badge variant="outline">
                    {book._count.digitalFiles} fișiere
                  </Badge>
                </div>
              ...
              <div className="flex items-center gap-4 text-sm text-muted-foreground">
                <div className="flex items-center gap-1">
                  ...
                  <span>{book._count.orderItems} vânzări</span>
                </div>
                <div className="flex items-center gap-1">
              ...
              <p className="text-xs text-muted-foreground">
                Creat la {new Date(book.createdAt).toLocaleDateString("ro-RO")}
              </p>
            </div>
          </CardContent>
        </Card>
